...
@InputType()
class EquipmentSaleUpdateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => EquidevUpdateManyWithoutEquipmentSalesInput,
  })
  @ValidateNested()
  @Type(() => EquidevUpdateManyWithoutEquipmentSalesInput)
  @IsOptional()
  @Field(() => EquidevUpdateManyWithoutEquipmentSalesInput, {
    nullable: true,
  })
...
export { EquipmentSaleUpdateInput };
