...
export class CompanyTypeControllerBase {
  ...
  @ApiNestedQuery(CompanyTypeFindManyArgs)
  async findManyCompanyTypes(
    @common.Req() request: Request,
    @common.Param() params: CompanyTypeWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<CompanyType[]> {
    const query = plainToClass(CompanyTypeFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findCompanyTypes(params.id, {
      ...query,
      select: {
        companyType: {
          select: {
  ...
  @common.Post("/:id/companyTypes")
  @nestAccessControl.UseRoles({
    resource: "CompanyType",
    action: "update",
    possession: "any",
  })
  async createCompanyTypes(
    @common.Param() params: CompanyTypeWhereUniqueInput,
    @common.Body() body: CompanyTypeWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
  ...
  @common.Patch("/:id/companyTypes")
  @nestAccessControl.UseRoles({
    resource: "CompanyType",
    action: "update",
    possession: "any",
  })
  async updateCompanyTypes(
    @common.Param() params: CompanyTypeWhereUniqueInput,
    @common.Body() body: CompanyTypeWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
  ...
  @common.Delete("/:id/companyTypes")
  @nestAccessControl.UseRoles({
    resource: "CompanyType",
    action: "update",
    possession: "any",
  })
  async deleteCompanyTypes(
    @common.Param() params: CompanyTypeWhereUniqueInput,
    @common.Body() body: CompanyTypeWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
