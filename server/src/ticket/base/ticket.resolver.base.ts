...
export class TicketResolverBase {
  ...
  async createTicket(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        taskPlanners: args.data.taskPlanners
          ? {
              connect: args.data.taskPlanners,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => TaskPlanner, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Ticket",
    action: "read",
    possession: "any",
  ...
  async taskPlanners(
    ...
    const result = await this.service.getTaskPlanners(parent.id);
